        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Ubah Kunjungan</h5>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="fasilitas">
                                        <option value="vaksin" <?= ($kunjungan['fasilitas'] == 'vaksin') ? 'selected' : ''; ?>>
                                            Vaksin
                                        </option>
                                        <option value="konsultasi" <?= ($kunjungan['fasilitas'] == 'konsultasi') ? 'selected' : ''; ?>>
                                            Konsultasi
                                        </option>
                                    </select>
                                </div>
